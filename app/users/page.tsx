    ...
    <>
      ...
      <div className="w-full  h-[74px] flex items-center justify-between px-4">
        <input
          ...
          className="w-[676px] h-[42px] bg-white rounded-lg border border-gray-200 text-[#adaebc] text-base font-normal font-['Inter'] leading-normal outline-none"
        />

        <div className="flex space-x-4">
          <div className="w-[113px] h-[42px] bg-[#efefef] rounded-lg border border-gray-200"></div>
          <div className="w-[103px] h-[42px] bg-[#efefef] rounded-lg border border-gray-200"></div>
          <button className="w-[147.94px] h-[42px] bg-white rounded-lg border border-gray-200 flex items-center justify-center">
